      ...
      <div>
        ...
        {designer.map((designerInfo) => (
          <div key={designerInfo.id} className="mb-4">
            <h2 className="text-2xl font-bold mb-3.5 font-Sans text-yellow-500">
      ...
      <div>
        ...
        {brand.map((brandInfo) => (
          <div key={brandInfo.id} className="mb-4">
            <h2 className="text-2xl font-bold mb-3.5 font-Sans text-orange-500">
              {brandInfo.brand}
            </h2>
            <p className="text-sm text-gray-200 text-base mb-2 font-Garamond">
      ...
      <div>
        ...
        {resource.map((resourceInfo) => (
          <div key={resourceInfo.id} className="mb-4">
            <h2 className="text-2xl font-bold font-Sans text-orange-500 mb-3.5">
              {resourceInfo.title}
            </h2>
            <p className="text-sm text-gray-200 text-base mb-2 font-Garamond">
